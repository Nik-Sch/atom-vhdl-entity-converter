...
export default {
  ...
  activate(state) {
    ...
    this.subscriptions.add(atom.commands.add("atom-workspace", {
      ...
      "vhdl-entity-converter:copy-as-sysverilog": () => this.copyAsSysVerilog(),
  ...
  getOptions() {
    return {"signalPrefix": atom.config.get("vhdl-entity-converter.signalPrefix"),
            "indentType": atom.config.get("vhdl-entity-converter.indentType"),
            "indentSpaceCount" : atom.config.get("vhdl-entity-converter.indentSpaceCount")}
  },
  ...
  copyAsSysVerilog() {
    this.copyBase("Instance", require("./templates").sysVerilogTemplate)
  },
